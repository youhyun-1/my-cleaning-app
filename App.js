...
<body>
    ...
    <script type="text/babel">
            ...
            function App() {
                ...
                return (
                    <div className="flex flex-col h-screen max-w-md mx-auto relative overflow-hidden shadow-2xl bg-[#F8F9FE]">
                        ...
                        <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-md-mx-auto bg-white/80 backdrop-blur-xl border-t border-slate-100 px-10 pb-10 pt-4 flex justify-between items-center z-40">
        ...
        // DOMContentLoaded 또는 라이브러리 로드 대기를 위한 안전 장치
